...
internal static class Utils
{
    ...
    /// </returns>
    public static string PluralizeWithQuantity(string singularWord, string pluralEnding, int quantity) => $"{quantity} {singularWord + (quantity == 1 ? "" : pluralEnding)}";
    ...
    public static void TypewriterEffect(string message, double speed, string? lineEnding = null)
    {
        ...
        var delay = (int)(1 / speed * CharacterDelay);
