...
internal sealed class ConversationBuilder
{
    ...
    /// <inheritdoc cref="HumanoidBase.Sudo(global::System.String[])" />
    public ConversationBuilder SudoTeacher(params string[] messages) => Sudo(Game.Teacher, messages);

    /// <inheritdoc cref="HumanoidBase.Sudo(global::System.String[])" />
    public ConversationBuilder SudoJack(params string[] messages) => Sudo(Game.Jack, messages);

    /// <inheritdoc cref="HumanoidBase.Sudo(global::System.String[])" />
    public ConversationBuilder SudoPrinciple(params string[] messages) => Sudo(Game.Principle, messages);
    ...
    private ConversationBuilder Sudo(HumanoidBase humanoid, params string[] message) => Perform(() => humanoid.Sudo(message));
}
