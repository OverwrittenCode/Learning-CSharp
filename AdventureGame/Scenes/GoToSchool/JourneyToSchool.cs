...
internal sealed class JourneyToSchool : BaseScene
{
    public JourneyToSchool()
    {
        Choices.Add(
            new(
                ...
                () =>
                {
                    ...
                    new ConversationBuilder().SudoUser("I'm so sorry, I only have a shilling to spare, it's all I have... really.")
                                             .Say("You give them one shilling")
                                             .Perform(() => Game.User.GiveMoney(Game.John, 0.12M))
                                             .SudoJohn("God bless you young man! Your parents taught you well. It's ok, I understand.")
        ...
        Choices.Add(
            new(
                ...
                () =>
                {
                    new ConversationBuilder().Say("You see their money stash: just under 3 shillings.")
                                             ...
                                             .Say($"{Game.John} trips you up, all of your money is scattered across the ground.")
                                             .Perform(
                                                  () =>
                                                  {
        ...
        Choices.Add(
            new(
                ...
                () =>
                {
                    new ConversationBuilder().SudoUser("Sorry, got something important to do!")
                                             .SudoJohn("*scoffs* Kids these days...")
                                             .Say("You swiftly jog back home,")
                                             .Say("You are panting; out of breath.")
                                             .SudoFather("School set on fire son?", "I've never seen this one run so fast!")
                                             ...
                                             .SudoMother("No, his jokes get worse by the day.", "Yesterday, he said something weird about some toaster and an egg?")
                                             .SudoUser("...")
                                             .Init();
    ...
    public override void Play()
        => new ConversationBuilder().Say(
                                    ...
                                    .SudoJohn("Hey kid, can you spare any change? Could really need some right now for some food and a drink.")
                                    .Init();
}
