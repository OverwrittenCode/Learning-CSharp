...
internal sealed class BasementDiscovery : BaseScene
{
    public BasementDiscovery()
    {
        Choices.Add(
            new(
                ...
                () =>
                {
                    new ConversationBuilder().Say("You accidentally make a noise, and they turn to see you.")
                                             ...
                                             .SudoUser("Wait, what?")
                                             .Pause()
                                             .SudoTeacher("Join us. Forget everything else. We can all make a difference. Even if that means fighting with fear.");
    ...
    public override void Play()
        => new ConversationBuilder().Say("You cautiously make your way down to the school basement.")
