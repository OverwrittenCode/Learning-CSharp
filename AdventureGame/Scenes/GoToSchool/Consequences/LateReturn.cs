...
{
    public LateReturn() => Choices.Add(new("Sneak into class", () => new ClassroomSneaking()));

    public override void Play()
        => new ConversationBuilder().Say("You decide to return to school after your city adventure.")
