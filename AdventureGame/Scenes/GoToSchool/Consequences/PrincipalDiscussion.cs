...
internal sealed class PrincipalDiscussion : BaseScene
{
    public PrincipalDiscussion()
    {
        ...
        Choices.Add(
            new(
                ...
                () =>
                {
                    new ConversationBuilder().SudoPrinciple("I'm giving you the benefit of the doubt kid. Next time there will be serious consequences. You're free to leave.")
                                             .Say("You leave their office and meet up with Jack again")
                                             .Pause()
                                             .SudoJack("Where were you?")
                                             .SudoUser("Not important. Well, actually no it is important. I think the principal is hiding something!")
                                             .SudoJack("What makes you think that?")
                                             .SudoUser("This entire day has felt weird, and I managed to find my note on deciphering")
                                             .SudoJack("Where are you going with this? Wait... what are you even on about?")
                                             .SudoUser(
                                             ...
                                             .SudoJack("Go on.")
                                             .SudoUser("I don't know how I didn't see it before, but that's when I recalled my note:")
                                             .Say("Shift each letter, a-z, back by a specific amount to decipher")
                                             .SudoUser("And the letter talked about something about irrational order! Don't you see?")
                                             .SudoJack("No, really I don't, please get to the point")
                                             .SudoUser("Ok long story short the order of the rules was off, the letter said:")
    ...
    public override void Play()
        => new ConversationBuilder().SudoUser("Sir, I'm concerned about what's happening in our country.")
