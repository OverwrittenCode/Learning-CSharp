...
internal sealed class EscapeAttempt : BaseScene
{
    ...
    {
        Choices.Add(new("Return to detention", () => new Detention()));
        Choices.Add(new("Continue escaping", () => new SchoolEscape()));
    }

    public override void Play()
        => new ConversationBuilder().Say("You quietly open the door and peek outside.")
