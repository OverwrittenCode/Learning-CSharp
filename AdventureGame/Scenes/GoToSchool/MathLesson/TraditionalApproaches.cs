...
internal sealed class TraditionalApproaches : BaseScene
{
    ...
    public override void Play()
        => new ConversationBuilder().SudoUser("Maybe we should look at what's worked in the past?")
                                    .SudoTeacher("Good thinking. Let's examine some traditional economic approaches.")
                                    .Say("The class discusses various established economic theories and their applications.")
                                    .Init();
}
