...
internal sealed class ChallengeTheTeacher : BaseScene
{
    public ChallengeTheTeacher()
    {
        Choices.Add(
            new(
                ...
                () =>
                {
                    new ConversationBuilder().SudoUser("No sir.").SudoTeacher("That's what I thought.").Init();
    ...
    public override void Play()
        => new ConversationBuilder().SudoUser("But sir, the homework was unreasonable given everything that's happening!")
