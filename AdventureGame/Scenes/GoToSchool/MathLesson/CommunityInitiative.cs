...
internal sealed class CommunityInitiative : BaseScene
{
    public CommunityInitiative()
    {
        ...
        Choices.Add(new("Suggest partnering with local businesses", () => new BusinessPartnership()));
    }

    public override void Play()
        => new ConversationBuilder().SudoUser("What can we do as students to help our local community?")
