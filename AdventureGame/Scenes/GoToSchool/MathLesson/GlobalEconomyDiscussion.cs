...
internal sealed class GlobalEconomyDiscussion : BaseScene
{
    ...
    public override void Play()
        => new ConversationBuilder().SudoTeacher("The global economy is interconnected. What happens in one country affects others...")
                                    .Say("The teacher explains concepts like trade wars, currency fluctuations, and global market trends.")
