...
internal sealed class JustAssumptions : BaseScene
{
    ...
    {
        Choices.Add(new("Explore the house", () => new HouseExploration()));
        Choices.Add(new("Sneak out to meet Jack", () => new MeetJack()));
    }

    public override void Play()
        => new ConversationBuilder().Say("You've decided to stay at home, ignoring the school's letter.")
