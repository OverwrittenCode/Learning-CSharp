...
internal sealed class Intro : BaseScene
{
    public Intro()
    {
        Choices.Add(new("Yes", () => new LetterReceived()));
        Choices.Add(
            new(
                "No",
                () =>
                {
                    new ConversationBuilder().SudoUser("Yeah yeah yeah, I'll read it in my room")
                                             .SudoFather("You better")
                                             .Say("You go upstairs into your room")
                                             .Pause()
                                             .SudoFather("Kid thinks I was born yesterday, I better check what he's doing")
                                             .Say("He quietly goes upstairs to overhear your rant.")
                                             .Pause()
                                             .SudoUser("He thinks I'm actually reading that? Pft.", "I'd rather watch Jack throw another frisbee at that bald maths teacher.")
