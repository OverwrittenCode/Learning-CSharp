...
internal sealed class GovernmentBonds : BaseScene
{
    public override void Play()
        => new ConversationBuilder().Say("You decide to invest in government bonds, prioritizing safety over high returns.")
                                    .Say("Over the years, your cautious approach provides stability during economic turbulence.")
