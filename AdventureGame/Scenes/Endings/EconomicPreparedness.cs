...
internal sealed class EconomicPreparedness : BaseScene
{
    public override void Play()
        => new ConversationBuilder().Say("You focus on developing strategies to prepare for future economic challenges.")
                                    .Say("Your foresight helps individuals and businesses build resilience against economic shocks.")
