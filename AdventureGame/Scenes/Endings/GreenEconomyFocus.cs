...
internal sealed class GreenEconomyFocus : BaseScene
{
    public override void Play()
        => new ConversationBuilder().Say("You choose to focus on sustainable industries and the green economy.")
                                    .Say("Your studies and later career revolve around renewable energy and sustainable development.")
