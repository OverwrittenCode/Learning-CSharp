...
internal sealed class StudentRepresentative : BaseScene
{
    public override void Play()
        => new ConversationBuilder().Say("You become the official student representative, working with the school administration.")
                                    ...
                                    .Say("Your success in negotiating student interests paves the way for your future in politics.")
