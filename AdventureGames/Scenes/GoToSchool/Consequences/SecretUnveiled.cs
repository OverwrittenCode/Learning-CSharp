...
internal sealed class SecretUnveiled : BaseScene
{
    ...
    {
        Choices.Add(new Choice("Join the resistance", () => new UndergroundResistance()));
        Choices.Add(new Choice("Pretend you saw nothing", () => new InnerConflict()));
    }

    public override void Play()
    {
        new ConversationBuilder()
            .Say("You overhear the conversation in the basement.")
            .SudoTeacher(
