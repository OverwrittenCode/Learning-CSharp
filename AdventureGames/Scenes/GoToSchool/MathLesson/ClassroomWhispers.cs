...
internal sealed class ClassroomWhispers : BaseScene
{
    ...
    {
        Choices.Add(new Choice("Share what you've heard", () => new RumourSpread()));
        Choices.Add(new Choice("Keep the information to yourself", () => new SecretKeeper()));
    }

    public override void Play()
    {
        new ConversationBuilder()
            .Say("You lean over to whisper to your classmate.")
            .SudoUser("Psst... have you noticed anything weird going on?")
            .Say("Your classmate looks around nervously before replying.")
            .Say(
                "Classmate: (whispering) My parents said something about a secret meeting in the school basement..."
            )
