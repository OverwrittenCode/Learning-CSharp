...
internal sealed class PessimisticOutlook : BaseScene
{
    ...
    public override void Play()
    {
        new ConversationBuilder()
            .SudoTeacher(
                "Some economists predict challenging times ahead. Let's examine these forecasts."
            )
            .Say(
                "The teacher presents some concerning economic predictions and their potential impacts."
            )
