...
internal sealed class HighRiskInvesting : BaseScene
{
    ...
    public override void Play()
    {
        new ConversationBuilder()
            .SudoTeacher(
                "High-risk investments offer the potential for significant returns, but also carry greater danger of loss."
            )
            .Say(
                "The teacher outlines various high-risk investment strategies and their potential outcomes."
            )
