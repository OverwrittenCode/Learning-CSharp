...
internal sealed class TradeAgreementDiscussion : BaseScene
{
    ...
    {
        Choices.Add(
            new("Express concern about unfair trade practices", () => new EconomicActivism())
        );
    ...
    public override void Play()
    {
        new ConversationBuilder()
            .SudoTeacher("Trade agreements shape the global economy. Let's discuss their impact.")
            .Say(
                "The teacher explains various trade agreements and their effects on different countries."
            )
