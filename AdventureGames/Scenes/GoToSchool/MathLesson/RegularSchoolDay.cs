...
internal sealed class RegularSchoolDay : BaseScene
{
    ...
    public override void Play()
    {
        new ConversationBuilder()
            .Say("The rest of the school day passes relatively normally.")
            .Say(
                "You attend your classes, but your mind keeps drifting back to the earlier discussions."
            )
            .SudoUser(
                "(thinking) Everything seems so normal, yet so much is happening beneath the surface."
            )
            .Init();
    }
}
