...
internal sealed class CareerGuidance : BaseScene
{
    ...
    public override void Play()
    {
        new ConversationBuilder()
            .SudoUser("Given the current economic situation, what career paths should we consider?")
            .SudoTeacher("That's a forward-thinking question. Let's discuss some options...")
            .Say(
                "The teacher provides insights into various career opportunities and their prospects."
            )
            .Init();
    }
}
