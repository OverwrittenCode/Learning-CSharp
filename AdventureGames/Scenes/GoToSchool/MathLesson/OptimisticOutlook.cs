...
internal sealed class OptimisticOutlook : BaseScene
{
    ...
    public override void Play()
    {
        new ConversationBuilder()
            .SudoTeacher(
                "While challenges exist, there are also opportunities for growth and improvement."
            )
            .Say(
                "The teacher outlines potential positive outcomes and strategies for economic recovery."
            )
