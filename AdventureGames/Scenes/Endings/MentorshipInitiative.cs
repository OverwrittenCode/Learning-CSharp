...
internal sealed class MentorshipInitiative : BaseScene
{
    public override void Play()
    {
        new ConversationBuilder()
            .Say(
                "You launch a mentorship program, connecting students with experienced professionals."
            )
            .Say(
                "The initiative provides guidance and real-world insights to aspiring young minds."
            )
