...
internal sealed class InternshipProgram : BaseScene
{
    public override void Play()
    {
        new ConversationBuilder()
            .Say("You successfully establish an internship program with local businesses.")
            .Say(
                "The program provides valuable experience for students and fresh ideas for companies."
            )
