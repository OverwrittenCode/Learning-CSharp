...
internal sealed class InnovationFocus : BaseScene
{
    public override void Play()
    {
        new ConversationBuilder()
            .Say("You dedicate yourself to fostering innovation in various sectors of the economy.")
            .Say(
                "Your efforts lead to breakthroughs in technology, energy, and sustainable practices."
            )
