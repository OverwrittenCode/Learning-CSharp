...
internal sealed class LateSchoolArrival : BaseScene
{
            ...
            new(
                ...
                () =>
                {
                    new ConversationBuilder()
                        .SudoUser("Let's take that route")
                        .Say("You turn away from Jack and walk forwards")
                        .SudoTeacher(
                            $"{Game.User.ToString().ToUpperInvariant()}! This is the last time you act up in school!"
                        )
                        ...
                        .Pause()
                        .Say(
                            "You turn around and Jack is gone. He thought you meant the long route by \"that\" route."
                        )
                        .Init();
    ...
    public override void Play()
    {
        ...
        new ConversationBuilder()
            .Say("You and Jack arrive at school late.")
