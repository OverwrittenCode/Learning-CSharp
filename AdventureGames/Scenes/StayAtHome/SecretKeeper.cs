...
internal sealed class SecretKeeper : BaseScene
{
    ...
    {
        Choices.Add(
            new("Investigate further", () => new SecretInvestigation(isFromFriendshipTest))
        );
    ...
    public override void Play()
    {
        new ConversationBuilder()
            .Say("You decide to keep the secret to yourself.")
            .SudoUser(
                "(thinking) I can't believe what I've discovered. What should I do with this information?"
            )
